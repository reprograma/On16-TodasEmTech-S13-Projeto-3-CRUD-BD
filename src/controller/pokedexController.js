...
const { findById } = require('../models/pokedexModel')
...
const createPokemon = async (req, res) =>{
    try{
      ...
      // new pokedex model -> gera um novo modelo
...
module.exports = { createPokemon, findAllPokemons, findPokemonById, updatePokemonById, deletePokemonById}